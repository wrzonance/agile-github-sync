...
# Runnable both ways: `python -m agilesync.tools.probe_dependencies` from the repo root, and
# `python path/to/agilesync/tools/probe_dependencies.py` from anywhere. Direct execution puts this
